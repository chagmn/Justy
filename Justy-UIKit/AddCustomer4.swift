...
class AddCustomer4: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        childInfo_boy.text = "남"
        childInfo_boy.textAlignment = .center
        childInfo_boy.textColor = .black
        
        childInfo_girl.text = "여"
        childInfo_girl.textAlignment = .center
        childInfo_girl.textColor = .black
    }
    ...
    func autoLayout(){
        ...
        textField_AttestedCopy.topAnchor.constraint(equalTo: micBtn.bottomAnchor, constant: 20).isActive = true
        textField_AttestedCopy.trailingAnchor.constraint(equalTo: Btn_AttestedCopy.leadingAnchor, constant: -20).isActive = true
        textField_AttestedCopy.widthAnchor.constraint(equalTo: view.widthAnchor, constant: (screenWidth-300)).isActive = true
        
        Btn_AttestedCopy.translatesAutoresizingMaskIntoConstraints = false
        Btn_AttestedCopy.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 200).isActive = true
